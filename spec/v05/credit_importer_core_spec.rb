...
RSpec.describe V05::CreditImporterCore do
  subject{V05::CreditImporterCore}
  let(:import_summary) { V05::Core::ImportSummary.new(0,0,0)}
  ...
  describe "when fetch_credits fails" do
    let(:fetch_credits) {
      -> () {
        V05::Core::Failure.new(HTTP::Error.new("something went bad"))
      }
    }
